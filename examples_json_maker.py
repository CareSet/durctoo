...
def create_login_form():
    """Create a simple login form and save its JSON."""
    form = HTML5FormData(
        form_id="login_form",
...
def create_registration_form():
    """Create a more complex registration form and save its JSON."""
    form = HTML5FormData(
...
def create_survey_form():
    """Create a survey form with various question types and save its JSON."""
    form = HTML5FormData(
        form_id="survey_form",
        method=FormMethod.POST,
